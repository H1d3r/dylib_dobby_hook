...
current_path=$PWD
ida_path="/Applications/IDA Professional 9.4.app"
...
codesign --force --deep --sign - /Applications/IDA\ Professional\ 9.4.app/Contents/MacOS/libida64.dylib
codesign --force --deep --sign - /Applications/IDA\ Professional\ 9.4.app/Contents/MacOS/libida32.dylib
codesign --force --deep --sign - /Applications/IDA\ Professional\ 9.4.app/Contents/MacOS/libida.dylib
